...
test_data_root = '../outputs/coco_ovd_images/coco_novel_ft6_3000/'
test_ann = 'anns_thr0.8_all_images.json'
...
model = dict(
    ...
    backbone=dict(
        ...
        sd_ckpt="../checkpoints/stable-diffusion-v-1-4-original/sd-v1-4.ckpt"  # we use the original model weights of SDM in the last denoising step
    ),
    neck=dict(
        type='ChannelMapper',
...
work_dir = './work_dirs/instagen-4scale_fd_8xb2-12e_coco_infer'
