...
from ..layers import ContrastiveEmbed
...
class GroundingHead(DeformableDETRHead):
    def _init_layers(self) -> None:
        """Initialize classification branch and regression branch of head."""
        fc_cls = ContrastiveEmbed(scale_bias=True, norm=True)
        reg_branch = []
    ...
    def init_weights(self) -> None:
        """Initialize weights of the Grounding Head."""
    ...
    def forward(self, hidden_states: Tensor,
        ...
        for layer_id in range(hidden_states.shape[0]):
            ...
            outputs_class = self.cls_branches[layer_id](hidden_state, memory_text)
    ...
    def predict(self,
        ...
        outs = self(hidden_states, references, **kwargs)
