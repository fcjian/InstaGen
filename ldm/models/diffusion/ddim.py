...
class DDIMSampler(object):
    ...
    def ddim_sampling(self, cond, shape,
                      ...
                      latent_feat=None, last_sample=False, print_flag=True):
        ...
        for i, step in enumerate(iterator):
            if last_sample and (i != len(iterator) - 1):
                continue
            ...
            if latent_feat is not None and (i == len(iterator) - 2):
                latent_feat[0] = img.clone()
